"""
Django settings for upeweb project.
...
INSTALLED_APPS = [
    ...
    'upeweb.events',
    'upeweb.tutoring',
    'upeweb.markdown_pages',
    'upeweb.shortlinks',
    'upeweb.alumni',
    'upeweb.candidate',
    'upeweb.elections',
    'upeweb.courses',
    'upeweb.coursesemester',
    'upeweb.exams',
    'upeweb.reviewsessions',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'upeweb.views.users.add_officer_context',
                'upeweb.views.users.add_exec_context'
            ],
        },
    },
]

WSGI_APPLICATION = 'upeweb.wsgi.application'
...
EMAIL_HOST_USER = 'upewebsite@upe.cs.berkeley.edu'
EMAIL_USE_TLS = True

NO_REPLY_EMAIL = 'no-reply@upe.cs.berkeley.edu'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'upeweb', 'static'),
]
...
#SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_DOMAINS = ['upe.cs.berkeley.edu']
...
# Markdown settings
MARKDOWNX_MARKDOWNIFY_FUNCTION = 'upeweb.utils.markdownify'
