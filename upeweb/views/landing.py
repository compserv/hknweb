...
from upeweb.models import Announcement

from upeweb.events.models import Event
from upeweb.reviewsessions.models import ReviewSession
# from upeweb.tutoring.models import Tutor
...
def about(request):
    return render(request, 'about/aboutupe.html')
