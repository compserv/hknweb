...
from upeweb.utils import get_rand_photo, get_semester_bounds
...
def send_challenge_confirm_email(request, challenge, confirmed):
    subject = '[UPE] Your officer challenge was reviewed'
...
def send_bitbyte_confirm_email(request, bitbyte, confirmed):
    subject = '[UPE] Your bit-byte request was reviewed'
