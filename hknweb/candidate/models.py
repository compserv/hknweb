...
class RequirementMergeRequirement(models.Model):
    ...
    candidateSemesterActive = models.ForeignKey('hknweb.Semester', on_delete=models.SET_NULL, null=True, help_text="Candidate semester this Merged Requirement will take place (ignored if it is a connected node)")
