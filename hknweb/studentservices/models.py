...
class CourseDescription(models.Model):
    ...
    def prerequisites(self):
        return [line.strip() for line in self.prerequisites_raw.splitlines() if line.strip()]
        ...
        for line in self.topics_covered_raw.splitlines():
            ...
            if line.startswith('-'):
                if topics and isinstance(topics[-1], dict):
                    ...
                    topics.append({"title": "Unnamed Topic", "subtopics": [line[1:].strip()]})
            else:
    ...
    def more_info_html(self):
        ...
        bold_text = re.sub(r'\*(.*?)\*', r'<span style="font-weight: bold; font-size: 1.2em;">\1</span>', self.more_info or "")
