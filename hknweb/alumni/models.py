...
with open(
    os.path.join(BASE_DIR, "hknweb/alumni/static/alumni/countries_states.txt")
) as f:
...
class Alumnus(models.Model):
    ...
    grad_season = models.CharField(
        max_length=6, choices=SEASONS, default=FALL, verbose_name="graduation season"
    )
