...
class LinkAdmin(admin.ModelAdmin):
    ...
    fields = ['name', 'redirect', 'active', 'created_by', 'created_at', 'updated_at']

    readonly_fields = ['created_at', 'updated_at']
    list_display = ('name', 'redirect', 'active', 'created_by', 'created_at', 'updated_at')
    list_filter = ['created_at', 'created_by', 'active', 'updated_at']
