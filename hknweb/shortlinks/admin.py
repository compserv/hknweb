...
class LinkAdmin(admin.ModelAdmin):
    ...
    fields = ['name', 'redirect', 'active', 'created_by', 'created_at', 'modified_at', 'last_accessed_at']

    readonly_fields = ['created_at', 'modified_at', 'last_accessed_at']
    list_display = ('name', 'redirect', 'active', 'created_by', 'created_at', 'modified_at', 'last_accessed_at')
    list_filter = ['created_at', 'created_by', 'active', 'modified_at', 'last_accessed_at']
